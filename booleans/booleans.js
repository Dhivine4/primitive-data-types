...
//
////////////////////// YOUR CODE BELOW THIS LINE ///////////////////////
let secretCodeLength = secretCode.length === 15;
let fifthCharacter = (secretCode.charAt(4) >= "A") && (secretCode.charAt(4) <= "Z");
let tenthCharacter = (secretCode.charAt(9) >= "0") && (secretCode.charAt(9) <= "9");

let codeIsValid = secretCodeLength && fifthCharacter && tenthCharacter;

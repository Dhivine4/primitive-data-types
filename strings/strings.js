...
let gotDataType = typeof newString;
...
//
////////////////////// YOUR CODE BELOW THIS LINE ///////////////////////
let result = mainStringIgnoreCase.toLowerCase();
let stringContainsIgnoreCase = result.includes(subStringIgnoreCase);
...
// let firstFourCharacters = getFirstFourCharacters.substr(0, 4);
